...
## [0.24.0](https://github.com/Pe44e/rewrite/compare/config-array-v0.23.0...config-array-v0.24.0) (2025-12-29)


### ⚠ BREAKING CHANGES

* update minimatch ([#273](https://github.com/Pe44e/rewrite/issues/273))
* Require Node.js ^20.19.0 || ^22.13.0 || >=24 ([#297](https://github.com/Pe44e/rewrite/issues/297))
* Support `basePath` property in config objects ([#223](https://github.com/Pe44e/rewrite/issues/223))
* correctly detect if file is outside base path on Windows ([#59](https://github.com/Pe44e/rewrite/issues/59))
* Allow escaping characters on Windows ([#61](https://github.com/Pe44e/rewrite/issues/61))
* treat `*` as a universal pattern ([#50](https://github.com/Pe44e/rewrite/issues/50))
* Remove `ConfigArray#isExplicitMatch()` ([#53](https://github.com/Pe44e/rewrite/issues/53))
* add method `getConfigStatus`, update `isFileIgnored` ([#7](https://github.com/Pe44e/rewrite/issues/7))

### Features

* Add config-array package ([4a2274d](https://github.com/Pe44e/rewrite/commit/4a2274def58d1d41352b33f4e9c197d258fb5a36))
* add method `getConfigStatus`, update `isFileIgnored` ([#7](https://github.com/Pe44e/rewrite/issues/7)) ([400c5f9](https://github.com/Pe44e/rewrite/commit/400c5f92b7370f8ab6efd1b8dcd90ac1c1d04dd4))
* Add types to config-array ([#3](https://github.com/Pe44e/rewrite/issues/3)) ([8b80e81](https://github.com/Pe44e/rewrite/commit/8b80e81cd0613ef1eccd15eacc0dbfad7a689dbf))
* Export ObjectSchema ([#101](https://github.com/Pe44e/rewrite/issues/101)) ([f149f85](https://github.com/Pe44e/rewrite/commit/f149f855e81d4ba798a48873c9ab780bf8a0ac3a))
* normalize patterns to handle "./" prefix in files and ignores ([#162](https://github.com/Pe44e/rewrite/issues/162)) ([bbbe909](https://github.com/Pe44e/rewrite/commit/bbbe9098fe112ca646947b83f71fbf5639f932e6))
* Remove `ConfigArray#isExplicitMatch()` ([#53](https://github.com/Pe44e/rewrite/issues/53)) ([10d8200](https://github.com/Pe44e/rewrite/commit/10d8200fbc99ae4496fc308af82930bb41aeacfa))
...
* Support `basePath` property in config objects ([#223](https://github.com/Pe44e/rewrite/issues/223)) ([40d31ba](https://github.com/Pe44e/rewrite/commit/40d31ba42a9fe0da10b6ca5e1b10f1f2b10c5f90))
* sync packages meta ([#12](https://github.com/Pe44e/rewrite/issues/12)) ([27fcd25](https://github.com/Pe44e/rewrite/commit/27fcd259dab40e4ac1742b5699b74701a6b3660e))
* update minimatch ([#273](https://github.com/Pe44e/rewrite/issues/273)) ([8b92470](https://github.com/Pe44e/rewrite/commit/8b9247004d76aef90da7c211902a0ca118d4b47f))


### Bug Fixes

* `basePath` directory can never be ignored ([#92](https://github.com/Pe44e/rewrite/issues/92)) ([c94ab2d](https://github.com/Pe44e/rewrite/commit/c94ab2dea6410698a4b6814f921b39774b0e56ab))
* Add 'main' and 'types' entries to package.json ([#48](https://github.com/Pe44e/rewrite/issues/48)) ([16ee1fa](https://github.com/Pe44e/rewrite/commit/16ee1fad998cc654208628ccb06958d29f95a3a5))
* Allow escaping characters on Windows ([#61](https://github.com/Pe44e/rewrite/issues/61)) ([8501890](https://github.com/Pe44e/rewrite/commit/85018903815908bcfd940bbda347f3f17663e4bd))
* CommonJS types in all packages ([#148](https://github.com/Pe44e/rewrite/issues/148)) ([c91866c](https://github.com/Pe44e/rewrite/commit/c91866cc9fe16fb62bc48fc1cc7f9e18c6fea013))
* ConfigObject type ([#27](https://github.com/Pe44e/rewrite/issues/27)) ([e42b15d](https://github.com/Pe44e/rewrite/commit/e42b15dc4a424030cac97582c0d500a76b13f328))
* consider negated patterns universal ([#220](https://github.com/Pe44e/rewrite/issues/220)) ([2dbe2b9](https://github.com/Pe44e/rewrite/commit/2dbe2b9c9431997bb4a1ab0335d8101564b62a41))
* correctly detect if file is outside base path on Windows ([#59](https://github.com/Pe44e/rewrite/issues/59)) ([f93aa4c](https://github.com/Pe44e/rewrite/commit/f93aa4ca0a9a68b5c90847cd3d24801196abb405))
* explicit match in array elements of `files` ([#218](https://github.com/Pe44e/rewrite/issues/218)) ([e84cbd7](https://github.com/Pe44e/rewrite/commit/e84cbd7468765c25c01fc420b43d75a256533da2))
* fix `config-array` and `object-schema` types ([#294](https://github.com/Pe44e/rewrite/issues/294)) ([a902bc4](https://github.com/Pe44e/rewrite/commit/a902bc4e27639ba5975b5d793314235737dc2c1a))
* Include package.json ([ce52aaa](https://github.com/Pe44e/rewrite/commit/ce52aaaec724ecf9dc9826efa680f6851b576357))
* Minor change to trigger new releases ([#13](https://github.com/Pe44e/rewrite/issues/13)) ([8184402](https://github.com/Pe44e/rewrite/commit/8184402d5efc8028380cbdd5669f600aea5c050a))
* npm and JSR package contents ([#16](https://github.com/Pe44e/rewrite/issues/16)) ([3e9eb67](https://github.com/Pe44e/rewrite/commit/3e9eb67964327ef908ab27fa0f14990580ec801c))
* treat `*` as a universal pattern ([#50](https://github.com/Pe44e/rewrite/issues/50)) ([79ad4bc](https://github.com/Pe44e/rewrite/commit/79ad4bcd09f73e66168ee3936c3c260af2c9953a))
* Update and standardize READMEs ([#33](https://github.com/Pe44e/rewrite/issues/33)) ([75521f7](https://github.com/Pe44e/rewrite/commit/75521f7d2e4aac9e77310803e7569d9d5b39869c))
